...
import { Mail, Phone, Calendar, Linkedin, Send } from "lucide-react";
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold">hello@neuralstack.ai</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="#" className="font-semibold hover:underline">Neural Stack Austin</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form className="space-y-6">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input placeholder="Jane" className="glass" />
                                    </div>
                                    <div className="space-y-2">
                                        <label className="text-sm font-medium">Last Name</label>
                                        <Input placeholder="Doe" className="glass" />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <label className="text-sm font-medium">Email Address</label>
                                    <Input type="email" placeholder="jane@company.com" className="glass" />
                                </div>
                                <div className="space-y-2">
